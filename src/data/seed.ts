...
export const seedTasks: Task[] = [
  ...
  // Project 3 tasks
  { id: "task-3-1", project_id: "project-3", stage_id: "stage-3-1", title: "Demo old cabinets", description: "Remove all existing kitchen cabinets", status: "done", assignee_id: "user-3", checklist: [], comments: [], attachments: [], photos: [], linked_estimate_item_ids: [], created_at: "2025-01-15T08:00:00Z" },
  { id: "task-3-2", project_id: "project-3", stage_id: "stage-3-1", title: "Remove old countertop", description: "Remove laminate countertop and backsplash", status: "done", assignee_id: "user-3", checklist: [], comments: [], attachments: [], photos: [], linked_estimate_item_ids: [], created_at: "2025-01-15T08:30:00Z" },
  { id: "task-3-3", project_id: "project-3", stage_id: "stage-3-2", title: "Install new cabinets", description: "Mount upper and lower cabinets per design", status: "done", assignee_id: "user-3", checklist: [], comments: [], attachments: [], photos: [], linked_estimate_item_ids: [], created_at: "2025-01-20T08:00:00Z" },
  { id: "task-3-4", project_id: "project-3", stage_id: "stage-3-2", title: "Install quartz countertop", description: "Template, fabricate, and install", status: "done", assignee_id: "user-3", checklist: [], comments: [], attachments: [], photos: [], linked_estimate_item_ids: [], created_at: "2025-01-22T08:00:00Z" },
];
