...
const seedItems: ProcurementItemV2[] = [
  ...
  {
    id: "proc-3-1", projectId: "project-3", stageId: "stage-3-2", categoryId: null,
    name: "Kitchen cabinet set — Hoff", spec: "Hoff", unit: "set",
    requiredQty: 1, orderedQty: 1, receivedQty: 1,
    plannedUnitPrice: 180000, actualUnitPrice: 180000,
    supplier: null, linkUrl: null, notes: null, attachments: [],
    createdFrom: "estimate", linkedTaskIds: ["task-3-3"], archived: false,
  ...
  },
  {
    ...
    name: "Quartz slab — White Storm", spec: "White Storm", unit: "m2",
    requiredQty: 4, orderedQty: 4, receivedQty: 4,
    plannedUnitPrice: 15000, actualUnitPrice: 15000,
    supplier: null, linkUrl: null, notes: null, attachments: [],
