...
const seedItems: ProcurementItemV2[] = [
  {
    ...
    type: "material",
    name: "Кабель ВВГнг 3×2.5", spec: "ВВГнг 3×2.5", unit: "м",
    requiredByDate: null,
    requiredQty: 200, orderedQty: 200, receivedQty: 200,
    plannedUnitPrice: 40, actualUnitPrice: 40,
    supplierPreferred: null, locationPreferredId: null, lockedFromEstimate: false,
  ...
  },
  {
    ...
    type: "material",
    name: "Трубы ПП 20мм", spec: "20 мм", unit: "м",
    requiredByDate: null,
  ...
  },
  {
    ...
    type: "material",
    name: "Гипсокартон КНАУФ 12.5мм", spec: "12.5 мм", unit: "шт",
    requiredByDate: null,
  ...
  },
  {
    ...
    type: "material",
    name: "Плитка керамогранит 60×60", spec: "60×60", unit: "м²",
    requiredByDate: null,
  ...
  },
  {
    ...
    type: "material",
    name: "Стеклянные перегородки", spec: null, unit: "м²",
    requiredByDate: null,
  ...
  },
  {
    ...
    type: "material",
    name: "Брусчатка бетонная", spec: "20×10×6", unit: "м²",
    requiredByDate: null,
  ...
  },
  {
    ...
    type: "material",
    name: "Щебень дренажный фр. 20–40", spec: null, unit: "м³",
    requiredByDate: null,
    requiredQty: 8, orderedQty: 8, receivedQty: 5,
    plannedUnitPrice: 4000, actualUnitPrice: 4000,
    supplierPreferred: null, locationPreferredId: null, lockedFromEstimate: false,
    supplier: null, linkUrl: null, notes: "Ожидается поставка ещё 3 м³", attachments: [],
  ...
  },
  {
    ...
    type: "material",
    name: "Геотекстиль дорнит 150г/м²", spec: null, unit: "м²",
    requiredByDate: null,
  ...
  },
  {
    ...
    type: "material",
    name: "Декоративный гравий", spec: null, unit: "м³",
    requiredByDate: null,
    requiredQty: 3, orderedQty: 0, receivedQty: 0,
    plannedUnitPrice: 6000, actualUnitPrice: null,
    supplierPreferred: null, locationPreferredId: null, lockedFromEstimate: false,
    supplier: null, linkUrl: null, notes: "Задержка у поставщика — ожидается на следующей неделе", attachments: [],
  ...
  },
  {
    ...
    type: "material",
    name: "Бордюр газонный алюминиевый", spec: null, unit: "м",
    requiredByDate: null,
...
export function getAllProcurementItemsV2(includeArchived = false): ProcurementItemV2[] {
  return items.filter((i) => includeArchived || !i.archived);
}
