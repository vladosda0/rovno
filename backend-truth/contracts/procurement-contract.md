...
| `public.get_procurement_ai_operational_evidence(uuid, integer, integer)` | `jsonb` | yes | `rpc` | `supabase/migrations/20260414140000_wave3_procurement_ai_operational_evidence_rpc.sql` |
